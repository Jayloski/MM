...
export const ASSETS: Asset[] = [
  ...
  { ticker: 'USDJPY=X', label: 'JPY Index',      assetClass: 'futures', subGroup: 'intl_index', sessions: [ASIAN_TOKYO, EUR_LONDON] },
  ...
  // USD
  { ticker: 'CAD=X',    label: 'USD/CAD', assetClass: 'forex', subGroup: 'usd', sessions: [EUR_LONDON, US_DXY] },
...
export const TIMEFRAME_CONFIGS: Record<Timeframe, TimeframeConfig> = {
  '5m':  { yfInterval: '5m',  lookbackBars: 200, fetchDays: 7,   label: '5 Min'  },
  '15m': { yfInterval: '15m', lookbackBars: 200, fetchDays: 14,  label: '15 Min' },
  '1h':  { yfInterval: '60m', lookbackBars: 200, fetchDays: 60,  label: '1 Hour' },
  '4h':  { yfInterval: '60m', resampleFactor: 4, lookbackBars: 200, fetchDays: 120, label: '4 Hour' },
  '1d':  { yfInterval: '1d',  lookbackBars: 252, fetchDays: 400, label: 'Daily'  },
};
